...
EXT_BUNDLE_ID = "com.easyright.app.extension"
...
APP_PATH = "/Applications/EasyRight.app"
APP_BIN_FRAGMENT = "EasyRight.app/Contents/MacOS/EasyRight"
...
def kill_host():
    ...
    subprocess.run(["pkill", "-9", "-f", "EasyRightExtension"], check=False)
