...
rm -rf "$HOME/Library/Services/EasyRightQuickActions.service"
...
rm -rf "$HOME/Library/Containers/org.antigravity.EasyRight.Extension/Data" 2>/dev/null || true
rm -rf "$HOME/Library/Containers/com.easyright.app.extension/Data" 2>/dev/null || true
