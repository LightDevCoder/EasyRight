...
public enum FinderQuickActionPolicy {
    ...
    public static let recommendedActionIDs = [
        ...
        "easyright.action.filemanage.copyName",
        "easyright.action.terminal.terminal",
        "easyright.action.utility.calculateSHA256"
    ]
...
public enum FinderQuickServiceManifest {
    public static func encodedData(
        ...
        let services: [[String: Any]] = items.enumerated().map { offset, item in
            ...
            return [
                "NSMenuItem": [
                    "default": "EasyRight · \(offset + 1)\(favoriteMarker) \(item.title)"
                ],
        ...
        let propertyList: [String: Any] = [
            ...
            "CFBundleDisplayName": "EasyRight快捷动作",
