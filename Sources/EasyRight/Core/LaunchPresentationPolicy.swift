...
public enum LaunchPresentationPolicy {
    public static let backgroundLaunchArgument = "--easyright-background"
    public static let userOpenArgument = "--easyright-user-open"
    public static let permissionRefreshArgument = "--easyright-permission-refresh"
