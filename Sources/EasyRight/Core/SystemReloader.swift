...
public enum SystemReloader {
    public static let configChangedNotification = Notification.Name("com.easyright.app.configChanged")
    public static let finderExtensionBundleIdentifier = "com.easyright.app.extension"
    ...
    public static func registerFinderExtension(
        ...
        let extensionURL = appBundleURL
            ...
            .appendingPathComponent("EasyRightExtension.appex", isDirectory: true)
