...
public enum FinderExtensionDiagnostics {
    public static let defaultExtensionBundleIdentifier = "com.easyright.app.extension"
    ...
    /// 实时检测指定 bundleIdentifier 的访达扩展注册与启用状态
    public static func checkStatus(
        bundleIdentifier: String = defaultExtensionBundleIdentifier
    ) -> FinderExtensionRegistrationState {
        let query = SystemReloader.queryFinderExtension(bundleIdentifier: bundleIdentifier)
